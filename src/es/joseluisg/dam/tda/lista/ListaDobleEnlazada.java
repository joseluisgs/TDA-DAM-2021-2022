...
public class ListaDobleEnlazada<T> implements ILista<T> {
    ...
    public int insertarEnListaFinal(T dato) {
        if (tam == 0) {
            ...
            Nodo nuevo = new Nodo(dato);
            Nodo actual = this.fin; // me voy al ultimo
    ...
    public int borrarEnListaFinal() throws Exception {
        if (this.tam == 0) {
            ...
            if (tam == 1) {
                ...
                Nodo sup = this.fin;
                sup.anterior.siguiente = null;
                this.fin = sup.anterior; // o sup.anterior;
                this.tam--;
                return 0;
            }
        }
